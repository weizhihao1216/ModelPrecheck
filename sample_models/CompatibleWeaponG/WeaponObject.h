#ifndef COMPATIBLE_WEAPON_G_OBJECT_H
#define COMPATIBLE_WEAPON_G_OBJECT_H
...
public:
    ...
    int Initialize(int objectId, double lat, double lon, double alt,
        ...
        parameters.init_lat = lat + objectId * 0.0015;
        parameters.init_lon = lon - objectId * 0.001;
        parameters.init_alt = alt;
        parameters.init_speed = speed;
        parameters.init_heading = 50.0 + objectId * 5.0;
        parameters.init_pitch = 11.0;
...
#endif /* COMPATIBLE_WEAPON_G_OBJECT_H */
