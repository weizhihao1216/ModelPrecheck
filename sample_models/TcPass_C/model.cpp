...
void Integrate(State* s, TcPass_C_ModelOutput* o) {
...
int Model_Init(void* handle, const TcPass_C_ModelParams* params) {
...
int Model_Step(void* handle, TcPass_C_ModelOutput* output) {
...
const char* Model_GetInfo(void) {
    return "TcPass_C | unique types + namespace TcPass_C | no clash with TcPass_A";
}
