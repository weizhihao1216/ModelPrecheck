...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QsciLexerNASM_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QsciLexerNASM_t qt_meta_stringdata_QsciLexerNASM = {
    {
QT_MOC_LITERAL(0, 0, 13) // "QsciLexerNASM"
...
static const uint qt_meta_data_QsciLexerNASM[] = {
...
QT_INIT_METAOBJECT const QMetaObject QsciLexerNASM::staticMetaObject = { {
    QMetaObject::SuperData::link<QsciLexerAsm::staticMetaObject>(),
    qt_meta_stringdata_QsciLexerNASM.data,
